...
| 2026-07-24 | GitHub automated PR review | PR #59 head `bed2c84`（27 changed files） | GitHub Copilot PR reviewer + OpenAI Codex review | 3 inline threads / 2 unique findings: event table が full vocabulary に見えること，ChkTeX が section files を明示入力していないこと | table を selected subset と本文・caption で明示し，全 `paper/sections/*.tex` を ChkTeX hard gate に追加．全検査と page 4 目視を再実行し，threads へ返信後に最新 head を再レビュー |
