...
per-domain instantiations; the layer description below follows the pinned
commit's own architecture documentation.
% source: leray-hopf@7c15710a docs/architecture.md (module organization)
\emph{Galerkin approximation and finite-dimensional ODE
...
uses a local Rellich--Kondrachov embedding on balls, formalized in-repo,
combined with a Fréchet--Kolmogorov criterion and a countable diagonal
argument over an exhausting sequence of balls. \emph{Aubin--Lions compactness in time and
