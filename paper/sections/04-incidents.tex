...
finite box, and the truncated form is a finite sum over pairs of modes in
the box. A second placeholder asserted antisymmetry of the truncated form
for arbitrary $v$ and $w$. The standard proof, however, reindexes the
...
discrepancy between $b(u,v,w)$ and $-b(u,w,v)$ of approximately $80.7$
