...
Isabelle/HOL. During six weeks of development, a workflow defined by the owner routed GitHub Issues
through isolated Git worktrees and pull requests. Different models filled
the orchestrator role, with Fable used in later phases. The harness routes
